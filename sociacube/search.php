<?php
  ...
  if(isset($_GET['find'])){
    ...
    $sql = "select * from users where first_name rlike '$find' || last_name rlike '$find' limit 30";
    $DB = new Database();
    $results = $DB->read($sql);
          ...
          <?php
            ...
            if(!empty($_GET['find'])){
              ...
              if(is_array($results)){
                ...
                echo "<div style='text-align:center;font-size:17px;'>We didn't find any results</div><br>";
