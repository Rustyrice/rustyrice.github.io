...
<div style="min-height:400px;width:100%;background-color:white;text-align:center;position: relative;top:20px;border-radius:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
  ...
  <?php
    ...
    if(i_own_content($user_data)){
      ...
      echo "<div style='font-size:14px;color:gray;'>You are currently not following anyone. You can search for friends using the <a href='".ROOT."search' class='text-hover-underline' style='font-size:13px;float:none;color:none;'>search bar</a>.</div>";
    }else{
