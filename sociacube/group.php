	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b;border-radius:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
 							...
 							<?php if(!group_access($_SESSION['mybook_userid'],$group_data,'member')): ?>
								<?php if(!group_access($_SESSION['mybook_userid'],$group_data,'request')): ?>
		  							...
		  							<a href="<?=ROOT?>join/<?=$group_data['userid']?>">
										<input id="post_button" type="button" value="Join Group" style="margin-right:10px;background-color:#405d9b;width:auto;">
									</a>
								<?php else: ?>

									<input id="post_button" type="button" value="Request sent" style="margin-right:10px;background-color: #D16F14;width:auto;cursor:auto;">
								<?php endif; ?>
							<?php endif; ?>
							<?php if(group_access($_SESSION['mybook_userid'],$group_data,'member')): ?>
				...
				<a href="<?=ROOT?>group/<?php echo $group_data['userid'] ?>/members"><div id="menu_buttons">Members</div></a>
