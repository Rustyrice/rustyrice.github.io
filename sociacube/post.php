	<div id="post">
		...
		<div style="width: 100%;">
			<div style="font-weight: bold;color: #405d9b;width: 100%;">
				...
				<div class='post_text'><?=check_tags($ROW['post'])?></div>
			...
			<?php
				...
				if(file_exists($ROW['image']))
				{
					...
					if($ext == "jpeg" || $ext == "jpg"){
						...
						echo "<video controls autoplay muted style='width:100%;border-radius:10px;' >
