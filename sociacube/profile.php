    ...
    <div style="background-color: white;text-align: center;color: #405d9b;border-radius:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
      ...
      <br>
        <div style="font-size: 20px;color: black;">
          ...
          <br><span id="tag_name">@<?php echo $user_data['tag_name'] ?></span>
          ...
          <a href="<?=ROOT?>like/user/<?php echo $user_data['userid'] ?>">
	          <?php if($user_data['userid'] != $_SESSION['mybook_userid']){
	              echo "<input id='post_button' type='button' value='Follow $mylikes' style='margin-right:10px;background-color:#405d9b;width:auto;'>";
	            }
	          ?>
					</a>
      ...
      <br>
			<?php
				if($user_data['userid'] == $_SESSION['mybook_userid']){
					echo '<a href="'.ROOT. 'home"><div id="menu_buttons">Timeline</div></a>';
				}
			?>

      <a href="<?=ROOT?>profile/<?php echo $user_data['tag_name'] ?>/about"><div id="menu_buttons">About</div></a>
      <a href="<?=ROOT?>profile/<?php echo $user_data['tag_name'] ?>/followers"><div id="menu_buttons">Followers</div></a>
      <a href="<?=ROOT?>profile/<?php echo $user_data['tag_name'] ?>/following"><div id="menu_buttons">Following</div></a>
      <a href="<?=ROOT?>profile/<?php echo $user_data['tag_name'] ?>/photos"><div id="menu_buttons">Photos</div></a>

      <?php
	      if($user_data['userid'] == $_SESSION['mybook_userid']){
					echo '<a href="'.ROOT. 'profile/'.$user_data['tag_name'].'/groups"><div id="menu_buttons">Groups</div></a>';
	        echo '<a href="'.ROOT. 'profile/'.$user_data['tag_name'].'/settings"><div id="menu_buttons">Settings</div></a>';
	      }
      ?>
    </div>
