...
<div class="flex-container">
		...
		<div style="padding: 20px;">
			...
			<div id="posts_home">
				...
				if (isset($posts) && $posts) {
					...
					echo "<div id='post_bar' style='margin-top:30px;padding:20px;'>";
					echo "<div>";
					echo "<h3 style='font-size:21px;color:gray;text-align:center;'>No more posts</h3></div>";
					echo "<div style='font-size:15px;color:gray;text-align:center;'>Add more friends to see more posts in your News Feed.</div>";
					echo "<br>";
					echo "<a href='" . ROOT . "search?find=' style='text-decoration:none;'>";
					echo "<input id='post_button' type='button' value='Find Friends' style='background-color:#1877F2;width:auto;font-size:14px;float:none;border-radius:5px;margin:auto; display:block;'>";
					echo "</a>";
					echo "</div>";
					echo "<br><br><br>";
				} else {
	...
	<div class="flex-item-right">
		<div id="post_bar" style="max-height:340px;">
